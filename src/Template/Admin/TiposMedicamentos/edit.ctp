<nav class="col-md-2 columns" id="actions-sidebar">
    <ul class="nav nav-pills nav-stacked">
        ...
        <?= $this->Form->postLink(
                __(' Deletar'),
                ['action' => 'delete', $tiposMedicamento->id],
                ['confirm' => __('Tem certeza que deseja deletar {0}?', $tiposMedicamento->descricao),
...
<div class="tiposMedicamentos form col-md-10 columns content">
    <?= $this->Form->create($tiposMedicamento) ?>
    <fieldset>
        <legend><?= 'Editar Tipos Medicamento' ?></legend>
        <?php
