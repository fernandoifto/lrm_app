<div class="row">
    ...
    <div class="tiposMedicamentos index col-md-10 columns content table-responsive">
        ...
        <div class="content table-responsive">  
            <table class="table table-striped">
                ...
                <tbody>
                    <?php foreach ($tiposMedicamentos as $tiposMedicamento): ?>
                        <tr>
                            <td><?= h($tiposMedicamento->descricao) ?></td>
                            <td class="actions" style="white-space:nowrap">
                                <?= $this->Html->link(__(''), ['action' => 'edit', $tiposMedicamento->id], ['class' => 'btn btn-success btn-sm glyphicon glyphicon-edit', 'title' => 'Editar']) ?>
                                <?= $this->Form->postLink(__(''), ['action' => 'delete', $tiposMedicamento->id], ['confirm' => __('Tem certeza que deseja deletar # {0}?', $tiposMedicamento->id), 'class' => 'btn btn-danger btn-sm glyphicon glyphicon-trash', 'title' => 'Deletar']) ?>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
