<nav class="col-md-2 columns" id="actions-sidebar">
    <ul class="nav nav-pills nav-stacked">
        ...
        <?= $this->Form->postLink(
                ...
                ['confirm' => __('Tem certeza que deseja deletar  {0}?', $lote->numero),
    ...
    <fieldset>
        <legend><?= 'Editar Lote' ?></legend>
            ...
            <div class="row">
                ...
                <?=
                    $this->Form->control('dataVencimento', [
                        'type' => 'text',
                        'dateFormat' => 'd/m/Y',
                        'value' => $lote->dataVencimento->format('d/m/Y'),
            ...
            <div class="row">
                ...
                <?=
                    $this->Form->control('dataFabricacao', [
                        'type' => 'text',
                        'dateFormat' => 'd/m/Y',
                        'value' => $lote->dataFabricacao->format('d/m/Y'),
                        'onchange' => 'validateDate(this)'
                    ]);
                ?>   
            </div><br>
