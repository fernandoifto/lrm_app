<nav class="col-md-2 columns" id="actions-sidebar">
    <ul class="nav nav-pills nav-stacked">
        ...
        <?= $this->Form->postLink(
                ...
                ['confirm' => __('Tem certeza que deseja deletar {0}?', $medicamento->descricao),
...
<div class="medicamentos form col-md-10 columns content">
    <?= $this->Form->create($medicamento) ?>
    <fieldset>
        <legend><?= 'Edit Medicamento' ?></legend>
        <?php
            echo $this->Form->input('descricao', ['label' => 'Descrição']);
            echo $this->Form->input('principioAtivo', ['label' => 'Princípio ativo']);
        ?>
    </fieldset>
